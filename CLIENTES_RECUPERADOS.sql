          ...
          FROM PEDIDO_FAT P
             ...
             ,(SELECT P.PEDF_CLI_ID
                 ...
                 WHERE P.PEDF_EMP_ID = 2
                   ...
                   --AND TRUNC(P.PEDF_DTA_EMIS) < TO_DATE('01/01/2023')) PED_ANTIGOS
                   AND TRUNC(P.PEDF_DTA_EMIS) < TO_DATE('01/12/2022') - 120) PED_ANTIGOS
         WHERE P.PEDF_EMP_ID = 2
           AND TRUNC(P.PEDF_DTA_EMIS) >= TO_DATE('01/12/2022')
           AND TRUNC(P.PEDF_DTA_EMIS) <= TO_DATE('31/12/2022')
...
--RELACIONAMENTO ROTA
           ...
           AND P.PEDF_CLI_ID NOT IN (SELECT P.PEDF_CLI_ID
                                      ...
                                      WHERE P.PEDF_EMP_ID = 2
                                        ...
                                        AND P.PEDF_NR_NF IS NOT NULL
                                        AND TRUNC(P.PEDF_DTA_EMIS) <  TO_DATE('01/12/2022')
                                        --AND TRUNC(P.PEDF_DTA_EMIS) >= TO_DATE('31/01/2023'))
                                        AND TRUNC(P.PEDF_DTA_EMIS) >= TO_DATE('31/12/2022') - 120)
         GROUP BY 
             P.PEDF_CLI_ID) 
ORDER BY
1,2,3
